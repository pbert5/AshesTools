...
let
  ...
  definitions = {
    ...
    network = { description = "Network inspection, transfer, and troubleshooting tools"; category = "administration"; members = [ "curl" "wget" "httpie" "doggo" "nmap" "socat" "mtr" ]; };
  ...
  allNames = name: definition: (resolveNames name [ ]) ++ map (child: "awesome-nix:${child}") (definition.awesome or [ ]);
